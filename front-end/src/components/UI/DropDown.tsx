...
export const DropdownButton: React.FC<DropdownProps> = ({ 
  ...
  return (
    <div className={cn("flex relative text-left", className)} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 z-50 mt-1 w-48 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden">
          <div className="py-1">
